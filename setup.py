...
setup(
    ...
    install_requires=["ricxappframe==3.2.2", "pandas>=1.1.3", "joblib>=0.3.2", "Scikit-learn>=0.18", "mdclogpy<=1.1.1", "schedule>=0.0.0", "influxdb","numpy>=1.18.0",  # Ensure numpy is installed for numerical operations
        "tqdm"],
